defmodule KotkowoWeb.Components.Modals do
  ...
  def share_modal(assigns) do
    ...
    <div
      ...
      x-show="shown"
      class="fixed h-screen top-0 left-0 w-screen bg-blue-300/10 z-20"
    >
      <div class="flex flex-col gap-y-4 sm:gap-y-6 w-72 sm:w-96 left-1/2 top-1/2 p-4 -translate-x-1/2 -translate-y-1/2 border-gray border rounded-2xl bg-white shadow-xl fixed z-20">
