defmodule KotkowoWeb.LostAndFoundLive.FoundLive.Show do
  @moduledoc false
    ...
    case cat do
      ...
      {:error, message} ->
        ...
        {:noreply,
         ...
         |> push_navigate(to: ~p"/zaginione-znalezione/znalezione", replace: true)}
    end
  end
  ...
  def mount(%{"slug" => slug}, _session, socket) do
    socket =
      ...
      |> start_async(:load_cat, fn -> Client.get_found_cat_by_slug(slug) end)
