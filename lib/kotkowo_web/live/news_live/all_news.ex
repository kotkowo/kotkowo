  ...
  def pagination_bar(assigns) do
    ...
    <div class="flex flex-row text-xl gap-x-4 text-lg">
      <button :if={@selected_page != @first_page} phx-click="select_page" class="p-4" value={@selected_page - 1}>
        <img class="-scale-100" src={~p"/images/arrow_right.svg"} />
      </button>
      <img :if={@selected_page == @first_page} class="p-4" src={~p"/images/arrow_left.svg"} />
      ...
      <img :if={@selected_page == @last_page} class="-scale-100 p-4" src={~p"/images/arrow_left.svg"} />
      ...
      >
        <img src={~p"/images/arrow_right.svg"} />
      </button>
    </div>
    """
  end
